...
const config: SiteConfig = {
  ...
  socialCardAvatarImage: './src/content/jellyfaith.jpg',
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/jellyfaith',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/jellyfaith',
    mastodon: 'https://github.com/jellyfaith',
    email: 'https://github.com/jellyfaith',
    linkedin: 'https://github.com/jellyfaith',
    bluesky: 'https://github.com/jellyfaith',
    twitter: 'https://github.com/jellyfaith',
